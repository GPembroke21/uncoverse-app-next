...
const Wrapper = styled("div")(({ theme }) => ({ overflow: "hidden", flexDirection: "column", }));
const UncoverseContainer = styled(Grid)(({ theme }) => ({ margin: "2rem 0rem 0.5rem 0rem", display: "flex", justifyContent: 'flex-start', alignItems: "center", }));
const UncoverseLogo = styled(Box)(({ theme }) => ({ objectFit: "contain", marginRight: "0.5rem" }));
const Main = styled(Grid)(({ theme }) => ({ width: "100%", justifyContent: "space-between", alignItems: "center", }));
const LanderImageContainer = styled(Box)(({ theme }) => ({}));
const LanderTextContainer = styled(Box)(({ theme }) => ({}));
const LogoBar = styled(Grid)(({ theme }) => ({ display: "flex", flexDirection: "row", justifyContent: "flex-start", alignItems: "center", margin: '6px 0px 12px 0px' }));
const Logo = styled(Box)(({ theme }) => ({ position: 'relative', height: "clamp(2rem, 3.1vw, 3rem)", width: "clamp(2rem, 3.1vw, 3rem)", border: "1px solid #252425", borderRadius: "25px", backgroundColor: '#252425', marginRight: '6px', }));
