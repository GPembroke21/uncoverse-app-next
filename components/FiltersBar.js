...
const FiltersBarContainer = styled("div")(({ theme }) => ({ width: "calc(100%)", margin: "18px 0px 14px 0px", padding: "0px 10px 0px 14px", display: "flex", alignItems: "center", justifyContent: "space-between" }));
...
export default function FiltersBar() {
  ...
  return (
    <ThemeProvider>
      ...
      <AnalyticsContainer>
        <FiltersButton
          endIcon={<ShowChartIcon sx={{ width: '0.6em', height: '0.6em' }} />}
        >
          Analytics
        </FiltersButton>
      </AnalyticsContainer>
